...
export default function createLazyFile(
  FS,
  parent,
  name,
  datalength,
  ...
  LazyUint8Array.prototype.cacheLength = function LazyUint8Array_cacheLength() {
    ...
    var doXHR = () => {
      // console.log('LazyUint8Array', url, __dirname, path.join(__dirname,  url));
      if (url.endsWith('.a')) return fs.readFileSync(path.join(__dirname, 'lazy-cache', url));
      else return fs.readFileSync(path.join(__dirname, url));
