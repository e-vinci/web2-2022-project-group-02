...
var Module = (() => {
  ...
  return function (Module) {
    ...
    if (Module['locateFile']) {
      ...
      wasmBinaryFile = new URL('wasm-package.wasm', import.meta.url).toString();
    }
    ...
    var FS = {
      ...
      staticInit: () => {
        ...
        FS.filesystems = { MEMFS: MEMFS, IDBFS: IDBFS, PROXYFS: PROXYFS };
      },
    ...
    var ___cxa_is_pointer_type = (Module['___cxa_is_pointer_type'] = function () {
      return (___cxa_is_pointer_type = Module['___cxa_is_pointer_type'] = Module['asm']['F']).apply(
        null,
        arguments,
      );
    });
